...
main 브랜치에 반영된 화면설계 산출물 중 서비스 흐름을 이해하는 데 필요한 대표 화면만 선별했습니다. 전체 화면 이미지는 [submission/assets/screen-design](submission/assets/screen-design)에서 확인할 수 있습니다.

### 사용자 화면

| 진입 화면 | 작명 입력 | 결과 확인 | 이력 조회 |
|---|---|---|---|
| <img src="submission/assets/screen-design/user-01-landing.png" width="190" alt="사용자 랜딩 화면" /> | <img src="submission/assets/screen-design/user-11-input.png" width="190" alt="작명 입력 화면" /> | <img src="submission/assets/screen-design/user-13-results.png" width="190" alt="작명 결과 화면" /> | <img src="submission/assets/screen-design/user-16-history.png" width="190" alt="작명 이력 화면" /> |

### 관리자 화면

| 대시보드 | 공지 관리 | 회원 관리 | 통계 |
|---|---|---|---|
| <img src="submission/assets/screen-design/admin-03-dashboard.png" width="190" alt="관리자 대시보드" /> | <img src="submission/assets/screen-design/admin-04-notices.png" width="190" alt="공지 관리 화면" /> | <img src="submission/assets/screen-design/admin-07-users.png" width="190" alt="회원 관리 화면" /> | <img src="submission/assets/screen-design/admin-11-settings.png" width="190" alt="관리자 설정 화면" /> |
...
<p align="center">
  <img src="submission/assets/시스템_아키텍처.svg" alt="시스템 아키텍처" width="820" />
</p>
...
평가계획서의 필수 산출물(요구사항 정의서, 화면설계서, 시스템 구성도, 테스트 계획 및 결과 보고서)과 평가계획서 PDF는 `submission/`에, 그 외 팀 내부 작업 문서는 `docs/`에 둡니다.

| 구분 | 산출물 | 위치 |
|---|---|---|
| 요구사항 (필수) | 요구사항 명세서 | [submission/SKN29_4th_4team_요구사항명세서.md](submission/SKN29_4th_4team_요구사항명세서.md) |
| 화면 설계 (필수) | 화면설계서 | [submission/화면설계서_최종.md](submission/화면설계서_최종.md) |
| 화면 설계 (필수) | 화면 이미지 산출물 | [submission/assets/screen-design](submission/assets/screen-design) |
| 시스템 구조 (필수) | 시스템 구성도 문서 | [submission/시스템_구성도.md](submission/시스템_구성도.md) |
| 시스템 구조 (필수) | 시스템 아키텍처 이미지 | [submission/assets/시스템_아키텍처.svg](submission/assets/시스템_아키텍처.svg) |
| 테스트 (필수) | 테스트 계획 및 결과 보고서 | [submission/테스트_계획_및_결과_보고서.md](submission/테스트_계획_및_결과_보고서.md) |
| 평가 자료 | 평가계획서 PDF | [submission/SKN 29기_AI 활용 애플리케이션 개발_평가계획서.docx.pdf](<submission/SKN 29기_AI 활용 애플리케이션 개발_평가계획서.docx.pdf>) |
...
├── submission/                 # 평가 필수 산출물 (요구사항 정의서, 화면설계서, 시스템 구성도, 테스트 계획 및 결과 보고서, 평가계획서 PDF)
│   └── assets/
│       └── screen-design/     # 화면설계서용 화면 이미지
├── docs/
│   └── assets/team/           # README 팀원 이미지
│   # 그 외 *.md — 계획서, 배포 매뉴얼, 작업 가이드 등 팀 내부 문서
