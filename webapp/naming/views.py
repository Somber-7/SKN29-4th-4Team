...
def insights_view(request):
    ...
    insight_cards = [
        {"title": "순우리말 이름", "desc": "부드럽고 친근한 어감으로 꾸준히 사랑받는 순우리말 이름", "stat": "선호도 1위", "hanja": "韓"},
        {"title": "중성적 어감", "desc": "성별에 구애받지 않는 세련된 느낌의 중성적 이름", "stat": "최근 급상승", "hanja": "類"},
        {"title": "대법원 인명용", "desc": "사주와 조화를 이루며 뜻이 깊은 인명용 한자 이름", "stat": "스테디셀러", "hanja": "名"}
    ]
